...
Source0  : https://cpan.metacpan.org/authors/id/M/MA/MARKOV/MIME-Types-2.28.tar.gz
...
%prep
%setup -q -n MIME-Types-2.28
cd %{_builddir}/MIME-Types-2.28
pushd ..
cp -a MIME-Types-2.28 buildavx2
popd
